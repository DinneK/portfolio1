    ...
    <section id="email-form" className="mb-20 sm:mb-28 w-[min(100%,38rem)]">
      ...
      {showThankYou ? (
        ...
        <div className="flex gap-3">
          <input
            className="h-14 w-1/2 px-4 rounded-lg borderBlack dark:bg-white dark:bg-opacity-80 dark:focus:bg-opacity-100 transition-all dark:outline-none shadow-md"
            name="senderName"
            type="name"
            required
            maxLength={500}
        ...
        <textarea
          className="h-52 w-full my-3 rounded-lg borderBlack p-4 dark:bg-white dark:bg-opacity-80 dark:focus:bg-opacity-100 transition-all dark:outline-none shadow-md"
          name="message"
